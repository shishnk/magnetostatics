...
//         }
//
//         public SplineBuilder SetElements(Interval[] elements)
//         {
...
//             {
//                 if (!_elements[ielem].IsContain(_points[ipoint]) || checker[ipoint] != 1) continue;
//
//                 checker[ipoint] = -1;
...
//                 sum = 0.0;
//             } while (_elements[ielem].IsContain(changedPoint));
//         }
//     }
//
